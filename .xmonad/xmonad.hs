...
myManageHook = composeAll
    ...
    , className    =? "discord"                              --> doShift (S.workspaces !! 5)
    , className    =? "Signal"                               --> doShift (S.workspaces !! 5)
    , className    =? "Slack"                                --> doShift (S.workspaces !! 5)
    , className    =? ".blueman-manager-wrapped"             --> doShift (S.workspaces !! 6)
    , className    =? ".blueman-applet-wrapped"              --> doShift (S.workspaces !! 6)
    , className    =? "Pavucontrol"                          --> doShift (S.workspaces !! 6)
